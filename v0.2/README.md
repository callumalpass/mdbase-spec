# mdbase v0.2.1 archive

This directory preserves the complete v0.2.1 specification and implementer
material. The current protocol is [v0.3.0](../README.md). Existing collections
remain valid v0.2 collections until an explicit, reviewed migration is applied.
...
The repository also includes a draft optional runtime profile for active collections:
workflows, actions, events, capabilities, script-backed action implementations, run
state, leases, and semantic workflow validation. This profile is not part of the
current Levels 1-6 conformance suite.
...
| §16 | `16-runtime-profile.md` | Draft optional runtime profile |
