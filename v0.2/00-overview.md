...
The optional runtime profile in [§16](./16-runtime-profile.md) sketches how a collection can become active through workflows, actions, events, and capabilities. That profile is draft material and is not required for core conformance.
...
| [16-runtime-profile.md](./16-runtime-profile.md) | Draft optional runtime profile |
